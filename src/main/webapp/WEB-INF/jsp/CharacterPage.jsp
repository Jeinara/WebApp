<%@ page import="webProject.bean.CharacterExtra" %>
<%--
...
<% CharacterExtra chr = (CharacterExtra)request.getAttribute("character");%>
...
<html>
    ...
    <body>
        <table border=1>
            ...
            <tr>
                <td>Пол: <%=chr.getSex()%></td>
                <td>Национальность: <%=chr.getNationality()%></td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="3"><p><%=chr.getProfession()%></p></td>
            </tr>
            <tr>
